...
//输出引脚
#define  BSP_OUT01   PDout(7)
#define  BSP_OUT02   PGout(9)
#define  BSP_OUT03   PGout(10)
#define  BSP_OUT04   PGout(11)
//#define  BSP_OUT05   PEout(8)
//#define  BSP_OUT06   PEout(11)
//#define  BSP_OUT07   PEout(12)
//#define  BSP_OUT08   PEout(13)

//#define  BSP_OUT09  PEout(14)
//#define  BSP_OUT10  PEout(15)
//#define  BSP_OUT11  PDout(10)
//#define  BSP_OUT12  PDout(11)
//#define  BSP_OUT13  PDout(12)
//#define  BSP_OUT14  PDout(13)
//#define  BSP_OUT15  PDout(14)
//#define  BSP_OUT16  PDout(15)

//输入引脚
#define  BSP_IN01    PBin(4)
#define  BSP_IN02    PFin(12)
#define  BSP_IN03    PFin(13)
#define  BSP_IN04    PFin(14)
#define  BSP_IN05    PFin(15)
#define  BSP_IN06    PGin(0)
#define  BSP_IN07    PGin(1)
#define  BSP_IN08    PDin(11)

#define  BSP_IN09    PDin(12)
#define  BSP_IN10    PDin(13)
#define  BSP_IN11    PGin(2)
#define  BSP_IN12    PGin(3)
#define  BSP_IN13    PGin(4)
#define  BSP_IN14    PGin(5)
#define  BSP_IN15    PGin(6)
#define  BSP_IN16    PGin(7)

#define  RS485_EN    PCout(8)
...
typedef struct { 
          ...
          //每个通道显示状态
          CPU_INT08U Clear_RFIDBuf:1;                                                  
          //设备操作状态
          CPU_INT08U SysReset:1;           
          CPU_INT08U AutoMode:1;
          CPU_INT08U Start_Cart:1;
          CPU_INT08U Stop_Cart:1;
          //测试出错
          CPU_INT08U F_FixERRO:1;            
          CPU_INT08U F_TestERRO:1;
